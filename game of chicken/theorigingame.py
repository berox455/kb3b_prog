...
def gamble(cela_historie, moje_tahy, oponent_tahy):
  choice = ["H", "D"]
...
strategies = {"jestrab": jestrab, "holubice": holubice, "kiwi": kiwi ,"crow": crow,
              "jan": jan, "dodo": dodo, "gamble": gamble,
              "konipas_horsky": konipas_horsky,
              "heryho_chicken": heryho_chicken, "penkava": penkava,
              "chicken": chicken
              }
